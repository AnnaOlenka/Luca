        ...
        <div className="bg-gray-50 p-6 border-t border-gray-200">
          <div className="space-y-4">
            ...
            <div className="relative z-[100]" style={{ pointerEvents: 'auto' }}>
              ...
              <div className="relative" style={{ pointerEvents: 'auto', zIndex: 998 }}>
                <input
                  ref={rucInputRef}
                  type="text"
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10 relative z-[999] ${
